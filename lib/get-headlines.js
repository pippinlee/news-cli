    ...
    userInput.forEach(function(e) {
      scraperjs.StaticScraper
          ...
          .scrape(function($){
            ...
            if (e.name === 'Globe and Mail' || e.name === "Dallas News" || e.name === 'New York Times'){
...
var match = false;
if(process.argv[2] === 'canada' || process.argv[2] === 'usa' || process.argv[2] === 'toronto' || process.argv[2] === 'montreal' || process.argv[2] === 'vancouver' || process.argv[2] === 'CA' || process.argv[2] === 'NY' || process.argv[2] === 'IL' || process.argv[2] === 'TX' || process.argv[2] === 'MA' ){
  match = true;
  headlines();
}
